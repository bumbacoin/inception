...
#if defined(NDEBUG)
# error "Inception cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Inception Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = (Params().ProofOfWorkReward() >> ((nHeight - 1) / Params().SubsidyHalvingInterval())) * COIN;
    }
...
{
    RenameThread("inception-loadblk");
